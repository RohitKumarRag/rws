...
const airtableTableName = 'AppsList';
...
function fetchTitles() {
    fetch(url, {
        ...
        .then(data => {
            ...
            const AppsLists = document.getElementById('AppsLists');
            AppsLists.innerHTML = ''; // Clear existing list items
            ...
            data.records.forEach(record => {
                ...
                gameIcon.alt = 'App Icon';
                gameIcon.src = logo;
                // gameIcon.style.border-radius;'50px';
